  ...
  <div class="unloading-detail">
    ...
    <div class="page-container">
      ...
      <van-cell-group inset class="section">
        ...
        <van-cell title="卸货重量" :value="transportInfo.weight" />
        <van-cell title="卸货时间" is-link :value="transportInfo.unloadingTime" @click="showTimePicker = true" />
      </van-cell-group>
...
onMounted(() => {
  ...
  transportInfo.value = {
    ...
    unloadingTime: new Date().toLocaleString('zh-CN', {
      year: 'numeric',
      month: '2-digit',
      day: '2-digit',
      hour: '2-digit',
...
const onTimeConfirm = (value) => {
  transportInfo.value.unloadingTime = value.toLocaleString('zh-CN', {
    year: 'numeric',
    month: '2-digit',
    day: '2-digit',
    hour: '2-digit',
